...
function init() {
  ...
  arrow_up = document.querySelector(".ArrowUp");
  arrow_left = document.querySelector(".ArrowLeft");
  arrow_down = document.querySelector(".ArrowDown");
  arrow_right = document.querySelector(".ArrowRight");
